            ...
            <div class="card-body p-4 p-sm-5">
                ...
                <form class="needs-validation" action="/register" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="name" name="name" id="name" class="form-control form-control-custom" placeholder="name" required value="{{ old('name') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="username" name="username" id="username" class="form-control form-control-custom" placeholder="username" required value="{{ old('username') }}">
                        <div class="invalid-feedback">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" name="email" id="email" class="form-control form-control-custom" placeholder="Email" value="{{ old('email') }}" required>
                        <div class="invalid-feedback">
                            Harap masukkan email yang valid.
                        </div>
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary btn-primary-custom w-100 py-2">Register</button>
                </form>
            </div>
        </div>
    </div>
